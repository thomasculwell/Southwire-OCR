...
for file in dicta:
    ...
    multitif = 'C:\\"Program Files"\\IrfanView\\i_view64.exe /multitif=(C:\\Users\\culwellt\\Documents\\automation\\GUI\\tester\\' + file.split('.')[0] + '.tif,'
    ...
    if len(dicta[file]) > 1:
        for ptfile in dicta[file]:
            multitif = multitif + 'C:\\Users\\culwellt\\Documents\\automation\\GUI\\tester\\' + ptfile + ','
        multitif = multitif[:-1]
        multitif = multitif + '/killmesoftly'
        os.system(multitif)
    else:
        for ptfile in dicta[file]:
            convert = 'C:\\"Program Files"\\IrfanView\\i_view64.exe C:\\Users\\culwellt\\Documents\\automation\\GUI\\tester\\' + ptfile + ' /convert=C:\\Users\\culwellt\\Documents\\automation\\GUI\\tester\\' + file.split('.')[0] + '.tif'
        os.system(convert)
