...
instruction_text = """Instructions for Southwire ApplicationXtender Automation Program
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle('Southwire ApplicationXtender Automation')
        self.initUI()
    ...
    def initUI(self):
        ...
        self.button.setText('Instructions')
        self.button.move(75,90)
        self.button.clicked.connect(self.instructions_clicked)

        self.button2 = QPushButton(self)
        self.button2.setText('Convert')
        self.button2.clicked.connect(self.convert_clicked)
