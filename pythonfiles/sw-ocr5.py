...
def full_ocr(imgfile):
    ...
    for i in range(len(fulllist)):
        ...
        (fulllist[i+2]=='Page' or fulllist[i+2]=='page'):
            ...
            # print(rr2)
        elif re.search('[5][0][0]\d{7}', fulllist[i]):
            rr2 = re.match('[5][0][0]\d{7}', fulllist[i]).group()
        # else:
        #     rr2 = 'No Receiving Report # Found'
        ...
        fulllist[i+1]=='I'):
            ...
            # print(po2)
        elif re.search('[4][5][0]\d{7}', fulllist[i]):
...
filenames = ['2.1.jpg', '2.2.jpg', '2.3.jpg', '2.4.jpg']
